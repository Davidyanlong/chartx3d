...
var Component = function (_Events) {
    ...
    function Component(_coordSystem) {
        ...
        _this._root = _coordSystem._root;

        // //每一个组件存放在一个Group中
        // this.group = new Group();
        // this.name = '';
        _this.group = _this._root.renderView.addGroup({
...
var Bar = function (_Component) {
    ...
    function Bar(chart3d, opt) {
        ...
        var _this = possibleConstructorReturn(this, (Bar.__proto__ || Object.getPrototypeOf(Bar)).call(this, chart3d.currCoord));
...
var Framework = function (_Events) {
    inherits(Framework, _Events);

    function Framework() {
        classCallCheck(this, Framework);

        var _this = possibleConstructorReturn(this, (Framework.__proto__ || Object.getPrototypeOf(Framework)).call(this));
...
var RenderFont = function () {
    function RenderFont() {
        ...
        classCallCheck(this, RenderFont);
    ...
    createClass(RenderFont, [{
        ...
        value: function drawText(text) {
            ...
            var top = 0;
            var left = 0;
            var textMatric = me.measureText(text);
            var size = textMatric; //me.resetCanvasSize(textMatric);

            //调整文字在纹理中的位置
            //垂直方向
            var subWidth = size.height - textMatric.height;
            ...
            //水平方向
            var subHeight = size.width - textMatric.width;
        ...
        value: function drawTexts(texts) {
            ...
            var canvasSize = me.resetCanvasSize({
            ...
            texts.forEach(function (text, index) {
                ...
                //调整文字在纹理中的位置
                //垂直方向
                var subHeight = maxHeight - size.height;
                if (me.style.verticalAlign.toLowerCase() == 'middle') {
                    //middle
                    if (subHeight) {
                        top = subWidth * 0.5;
                ...
                //水平方向
                var subWidth = maxWidth - size.width;
                if (me.style.textAlign.toLowerCase() == 'center') {
        ...
        key: 'resetCanvasSize',
        value: function resetCanvasSize(size) {
            var me = this;

            var width = size.width; //_Math.ceilPowerOfTwo(size.width);
            var height = size.height; //_Math.ceilPowerOfTwo(size.height);
...
var View = function () {
    ...
    createClass(View, [{
        ...
        key: "project",
        value: function project(controlsOpts, mode) {
            this.mode = mode;
        ...
        value: function getVisableSize() {
            var currPosition = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : new Vector3$1();


            var result = { width: 0, height: 0, ratio: 0 };
        ...
        value: function createBox() {
            ...
            var materials = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : undefined;
        ...
        key: "createCommonLine",
        value: function createCommonLine() {
            var points = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
            var lineStyle = arguments[1];

            var group = this.addGroup({ name: 'commonLines' });
        ...
        key: "createLine",
        value: function createLine(origins, direction, length, lineWidth, lineColor) {
        ...
        key: "creatSpriteText",
        value: function creatSpriteText(texts, origins, fontStyle) {
            //相机变化距离,不改变大小
            ...
            var renderFont = new RenderFont({
                verticalAlign: 'middle',
                textAlign: 'right'
            });
            //todo  模糊需要解决
            //label高度
            var spriteHeight = 14 * 4;
            ...
            var maxSize = renderFont.drawTexts(texts);

            var size = maxSize; //renderFont.measureText(text);
            var spriteWidth = size.width / size.height * spriteHeight;
...
var InertialSystem = function (_Events) {
    inherits(InertialSystem, _Events);

    function InertialSystem(root) {
        classCallCheck(this, InertialSystem);

        var _this = possibleConstructorReturn(this, (InertialSystem.__proto__ || Object.getPrototypeOf(InertialSystem)).call(this));
        ...
        //中心的
        _this.center = new Vector3$1(0, 0, 0);
    ...
    createClass(InertialSystem, [{
        ...
        value: function getBoundbox() {
            ...
            var _opt = this._root.opt.controls;
            var _frustumSize = this._root.renderView.mode == 'ortho' ? _opt.boxHeight * 0.8 : _opt.boxHeight;
            var _width = _opt.boxWidth;
            var _depth = _opt.boxDepth;

            //斜边
            var _hypotenuse = _opt.distance || new Vector3$1(_width, 0, _depth).length();

            var _ratio = this._root.renderView.getVisableSize(new Vector3$1(0, 0, -_hypotenuse)).ratio;
...
var OrbitControls = function (_Events) {
    inherits(OrbitControls, _Events);
    ...
    function OrbitControls(object, domElement) {
        ...
        _this._scale = 1;
        _this._panOffset = new Vector3$1();
...
var Interaction = function (_Events) {
    ...
    function Interaction(scene, camera, domElement) {
        classCallCheck(this, Interaction);

        var _this = possibleConstructorReturn(this, (Interaction.__proto__ || Object.getPrototypeOf(Interaction)).call(this));
...
var Chart3d = function (_Events) {
    inherits(Chart3d, _Events);

    function Chart3d(opt) {
        classCallCheck(this, Chart3d);

        var _this = possibleConstructorReturn(this, (Chart3d.__proto__ || Object.getPrototypeOf(Chart3d)).call(this));

        _this.domSelector = opt.el;
        _this.opt = opt.opts;
        _this.data = opt.data;
        ...
        _this._data = parse2MatrixData(opt.data);

        //三维引擎初始化
        _this.app = new Application();

        //初始化渲染器
        _this.renderer = _this.app._framework.renderer;
        ...
        _this.inited = false;
        _this.dataFrame = _this._initData(_this._data, opt.opts); //每个图表的数据集合 都 存放在dataFrame中。
...
var AxisLine = function (_Component) {
    ...
    function AxisLine(_coordSystem, opts) {
        ...
        //轴的起点
        var _this = possibleConstructorReturn(this, (AxisLine.__proto__ || Object.getPrototypeOf(AxisLine)).call(this, _coordSystem));

        _this.origin = new Vector3$1(0, 0, 0);

        //轴的方向
        _this.dir = new Vector3$1(1, 0, 0);
...
var TickLines = function (_Component) {
    inherits(TickLines, _Component);

    function TickLines(_coordSystem, opts) {
        classCallCheck(this, TickLines);

        //点的起点位置集合
        var _this = possibleConstructorReturn(this, (TickLines.__proto__ || Object.getPrototypeOf(TickLines)).call(this, _coordSystem));
        ...
        //刻度线的宽带
        _this.lineWidth = opts.lineWidth;
...
var TickTexts = function (_Component) {
    inherits(TickTexts, _Component);

    function TickTexts(_coordSystem, opts) {
        classCallCheck(this, TickTexts);

        //起点位置集合
        var _this = possibleConstructorReturn(this, (TickTexts.__proto__ || Object.getPrototypeOf(TickTexts)).call(this, _coordSystem));
        ...
        _this._tickTextGroup = _this._root.renderView.addGroup({ name: 'tickTexts' });
...
var YAxis = function (_Component) {
    ...
    createClass(YAxis, [{
        ...
        value: function _initModules() {
            ...
            var _axisDir = new Vector3$1(0, 1, 0);
        ...
        value: function getBoundbox() {
            ...
            //轴线的boundBox
            var _axisLineBoundBox = this.axisLine.getBoundBox();

            //刻度线的boundBox
            var tickLineBoundBox = this.tickLine.getBoundBox();

            //刻度文本的boundBox
            var _axisTextBoundBox = this.tickText.getBoundBox();
...
var XAxis = function (_Component) {
    inherits(XAxis, _Component);

    function XAxis(_cartesionUI) {
        classCallCheck(this, XAxis);

        var _this = possibleConstructorReturn(this, (XAxis.__proto__ || Object.getPrototypeOf(XAxis)).call(this, _cartesionUI._coordSystem));
    ...
    createClass(XAxis, [{
        ...
        value: function _initModules() {
            //初始化轴线
            var _axisDir = new Vector3$1(1, 0, 0);
            var _coordSystem = this._coordSystem;
            var coordBoundBox = _coordSystem.getBoundbox();
        ...
        value: function _setXAxisHeight() {
            ...
            if (!me.enabled) {
                ...
                if (this.label.enabled) {
                    var height = this.label.fontSize * 1.2;
...
var ZAxis = function (_Component) {
    inherits(ZAxis, _Component);

    function ZAxis(_cartesionUI) {
        classCallCheck(this, ZAxis);

        var _this = possibleConstructorReturn(this, (ZAxis.__proto__ || Object.getPrototypeOf(ZAxis)).call(this, _cartesionUI._coordSystem));
    ...
    createClass(ZAxis, [{
        ...
        value: function _initModules() {
            ...
            //初始化轴线
            var _axisDir = new Vector3$1(0, 0, -1);
            var _coordSystem = this._coordSystem;
            var coordBoundBox = _coordSystem.getBoundbox();
            var _size = new Vector3$1();
            coordBoundBox.getSize(_size);
            ...
            var origin = new Vector3$1(width, 0, 0);
...
var Grid = function (_Component) {
    ...
    function Grid(_cartesionUI) {
        ...
        var _this = possibleConstructorReturn(this, (Grid.__proto__ || Object.getPrototypeOf(Grid)).call(this, _cartesionUI._coordSystem));
    ...
    createClass(Grid, [{
        ...
        value: function drawLine() {
            ...
            var lines = me._root.renderView.createCommonLine(LinesVectors, this.line);
...
var Cartesian3DUI = function (_Component) {
    inherits(Cartesian3DUI, _Component);

    function Cartesian3DUI(_coordSystem) {
        classCallCheck(this, Cartesian3DUI);

        //坐标轴实例
        var _this = possibleConstructorReturn(this, (Cartesian3DUI.__proto__ || Object.getPrototypeOf(Cartesian3DUI)).call(this, _coordSystem));
...
var AxisAttribute = function () {
    function AxisAttribute(root) {
        classCallCheck(this, AxisAttribute);
    ...
    createClass(AxisAttribute, [{
        ...
        value: function computeDataSection() {
            var joinArr = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
        ...
        key: '_setDataSection',
        value: function _setDataSection(yFields) {
        ...
        key: '_twoDimensional',
        value: function _twoDimensional(yFields) {
...
var Cartesian3D = function (_InertialSystem) {
    inherits(Cartesian3D, _InertialSystem);

    function Cartesian3D(root) {
        classCallCheck(this, Cartesian3D);

        //相对与世界坐标的原点位置

        var _this = possibleConstructorReturn(this, (Cartesian3D.__proto__ || Object.getPrototypeOf(Cartesian3D)).call(this, root));

        _this.origin = new Vector3$1(0, 0, 0);
        _this.center = new Vector3$1(0, 0, 0);

        _this.offset = new Vector3$1(0, 0, 0);
    ...
    createClass(Cartesian3D, [{
        ...
        value: function updatePosition() {
            ...
            var z = temp * Math.cos(theta);
            //平移实现以中心点为圆心的旋转结果
            var newPos = new Vector3$1(x, y, z);
            newPos.add(center);
...
var components = {
    ...
    create: function create(el, data, opts) {
        ...
        chart = new Chart3d({ el: el, data: data, opts: opts });
